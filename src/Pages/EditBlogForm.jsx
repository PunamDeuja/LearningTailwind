...
function EditBlogForm() {
  ...
  const fetchBlog = async () => {
    const response = await axios.get("https://67512d6569dc1669ec1d4f68.mockapi.io/blogs/" + data.id)
    setEditData({
  ...
  const updateBlog = async (e) => {
    e.preventDefault();
    const response = await axios.put(`https://67512d6569dc1669ec1d4f68.mockapi.io/blogs/${data.id}`, editData);
